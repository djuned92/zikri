...
(6, 'update lagi aaa', 'laksdj', 'Koala.jpg', '2016-09-13 11:38:26');
...
INSERT INTO `grup_anggota` (`id_grup_anggota`, `id_anggota`, `id_grup_pendaki`, `level_anggota`) VALUES
(1, 1, 1, 'anggota'),
(2, 2, 1, 'ketua');
...
(1, 4, 64, 'Acak Adul', 'Desa maju mundur', '0000-00-00 00:00:00');
...
INSERT INTO `kuota` (`id_kuota`, `id_jalur_pendakian`, `kuota`, `status_jalur_pendakian`, `harga`, `tanggal_kuota`, `create_at`) VALUES
...
(4, 'calon_pendaki', 'pendaki', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Aktif', '2016-09-08 07:18:33'),
...
--
ALTER TABLE `boking`
MODIFY `id_boking` int(3) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `grup_anggota`
--
ALTER TABLE `grup_anggota`
MODIFY `id_grup_anggota` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `grup_pendaki`
--
ALTER TABLE `grup_pendaki`
MODIFY `id_grup_pendaki` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `kuota`
MODIFY `id_kuota` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
