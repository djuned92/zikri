...
<!-- modal update-->
<?php foreach($jalur_cibodas as $r): ?>
<div class="modal fade" id="updateJadwal<?=$r->id_jadwal_pendakian?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?=base_url()?>admin/info_gunung/jalur_cibodas/update/<?=$r->id_jadwal_pendakian?>" class="form-horizontal pegawai" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
